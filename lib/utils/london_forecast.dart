...
class LondonForecast extends StatelessWidget {
  const LondonForecast({super.key});

  @override
  Widget build(BuildContext context) {
    Londondaily london = Londondaily();
    ForecastLondon forecast = ForecastLondon();
    return Scaffold(
      body: Container(
